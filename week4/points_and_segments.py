...
def fast_count_segments(starts, ends, points):
    ...
    for i in range(len(points)):
        ...
        segments_start_before_point = binary_search_start_points(segment_list_starts, points[i])
        segments_end_after_point = binary_search_end_points(segment_list_ends, points[i])
        
        segments_start_after_point = len(segment_list_starts) - len(segments_start_before_point)
        segments_end_before_point = len(segment_list_ends) - len(segments_end_after_point)
